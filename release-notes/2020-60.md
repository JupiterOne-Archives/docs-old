...
- New **J1QL query execution engine**! Currently available as a public beta, the
  ...
  > switch over. We want everyone to experience this improvement sooner via this
  > UI toggle.
...
- Fixed an issue with integration job container width were inconsistent.

- Fixed an issue with integration setup instructions scrolls the entire page
...
- Fixed an issue where the Y axis on the account usage would be clipped if the
