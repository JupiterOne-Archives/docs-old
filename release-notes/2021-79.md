...
- Introduced a new filter to define **Critical Assets** in the Assets app, 
  and a **Smart Class** query shorthand.
    ...
    Critical Assets are defined using a preset combination of entities classes and attributes 
    (e.g. Hosts and Applications tagged as production). This configuration can be easily customized
    to match your specific definition of what critical assets mean for your organization.
    
    Critical Assets can be reference in query via a specific "Smart Class" shorthand: `#CriticalAsset`. 
    
    This allows you to easily query and monitor important changes and receive alerts when a drift or
    problem occurs for any of the critical assets you care about. It allows you to focus and prioritize 
    ...
    This is the initial release of this capability. We will be adding some pre-built alert rules and Insights
    dashboards for critical assets soon.
...
- SAML SSO users with access to prod s3 buckets
...
Stay tuned as additional dashboards, alert rules, managed questions, and complaince frameworks & mappings are updated.
