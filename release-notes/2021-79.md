...
- Introduced a new quick filter for accessing critical assets in the Assets app. 
  ...
  Critical assets provides a shortcut for you to easily monitor important changes 
  in your cloud environment and receive alerts for new issues such as 
  security findings or changes in access controls around your critical 
  assets. This feature allows you to quickly focus on and resolve your most 
...
- Improved messaging in the UI when bulk synchronization fails.
