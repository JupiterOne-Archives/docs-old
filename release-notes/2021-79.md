...
- Introduced a new quick filter for accessing critical assets in the Assets app. When you open 
  Assets, the top banner shows the number of total assets with a link to the list of critical 
  assets. Critical assets is a class of assets for which you can create queries and alerts 
  to quickly access the most crucial data.
