...
- Introduced a new quick filter for accessing critical assets in the Assets app. Critical assets 
  ...
  Learn more about how to customize and use critical assets [here](https://github.com/JupiterOne/docs/blob/main/guides/asset-inventory-filters.md).
...
- Updated the JupiterOne query language to [enable relationship direction](  https://github.com/JupiterOne/docs/blob/main/docs/jupiterone-query-language.md) with the use 
