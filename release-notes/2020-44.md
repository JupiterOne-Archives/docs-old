...
two weeks, our dev team made **300+ commits** to the **new integration sdk** and
**200+ commits** across **8 new integrations**!
...
Initial release of several new integrations:
...
- [**Trend Micro**](../docs/integrations/trendmicro/index.md)

Updates to AWS and Azure:
...
- **[Azure]**:
  ...
  - Added Key Vault resources: `azure_keyvault_service` (keys and certs to be
    added soon).
