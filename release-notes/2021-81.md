...
If you had alread enabled this setting in your GitHub configurations, it continues to behave the same after J1 updates the UI.
...
It is still an option that you can cdhoose to enable or not.
