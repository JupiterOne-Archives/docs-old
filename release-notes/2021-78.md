...
- New Parameter feature supports the ability to define parameterized values such as secrets via API. These parameters can then be refenced in queries 
- and questions within J1QL. Learn more [here] (https://github.com/JupiterOne/docs/blob/main/docs/parameters.md#jupiterone-parameter-service). 
