...
- Improved the query policy editor for user group permissions to show that data from ANY permission filter will return results for users within the group.
