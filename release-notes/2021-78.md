...
- The query policy editor in the Account Settings page is improved to support the new array-based data structure recently change in the JupiterOne APIs.
- The Relationship Count is removed from the legend in the Account Usage graph as this data is not supported.
