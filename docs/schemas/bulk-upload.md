...
> IMPORTANT: Bulk upload appends all of the data to the
> current list of data.  To avoid unnecessary duplication of data,
> make sure to only upload data that is currently not in the system
